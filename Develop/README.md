...
In the integrated table, run `node index` and answer the prompts. (**NOTE**: If you don't have an answer for a prompt, enter N/A or none, and this can be edited or deleted by the user in the README md document. Additionally, for the **[Credits](#credits)** section, use a comma separated list for multiple entries). After answering the prompts, the README.md will be generated in the `/Develop` folder.

![example of app](Assets/placeholder.gif)
